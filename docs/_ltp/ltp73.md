...
date: 2019-10-13
mp3_url: https://media.lets-talk.ie/ltp/ltp73.mp3
blurb: In this solo show Bart shares his opinions on the next wave of
  photographic technology — computational photography. Bart starts with his
  argument as to why computational photography even is photography, and then
  explains why he’s so impressed with what the latest generation of smartphone
  cameras can do. Listen, subscribe, and get the show notes at
  lets-talk.ie/ltp73. This show is ad-free because of the generosity of
...
<p>In this solo show Bart shares his opinions on the next wave of photographic technology — computational photography. Bart starts with his argument as to why computational photography even is photography, and then explains why he's so impressed with what the latest generation of smartphone cameras can do.</p>
