...
So, what is this HSL pixel representation? Each pixel still gets three numbers, but this time the numbers represent it's **H**ue, **S**aturation, and **L**ightness.
...
3. yellow
4. green
5. aqua (a bluey greeney colour)
6. blue
7. purple
8. magenta (a pinkier purple)
